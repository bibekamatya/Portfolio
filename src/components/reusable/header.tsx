...
export const Header = ({ header, className }: HeaderProps) => (
  <div className="flex justify-center items-center mb-12">
    <div className="relative inline-flex group">
      <div
        className="absolute transition-all duration-1000 opacity-70 -inset-px bg-gradient-to-r from-[#378a84] to-[#2ba6a48d] rounded-xl blur-lg group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200 animate-tilt"
      ></div>
      <div
